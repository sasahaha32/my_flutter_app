        ...
        child: Column(children: [
          Padding( padding: const EdgeInsets.only(right: Dimensions.paddingSizeSmall),
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text(
                'best_offer'.tr,
                style: textBold.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.9)),
              ),
              ...
              InkWell(onTap: () => Get.to(() => MyOfferScreen()),
                child: Text(
                  ...
                  style: textRegular.copyWith(
                    color: Get.isDarkMode ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.75),
                  ),
                ),
              ),
            ]),
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Padding(padding: const EdgeInsets.only(right: Dimensions.paddingSizeSmall),
                        child: Text(
                          ...
                          style: textRegular.copyWith(
                            color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(0.8) : Theme.of(context).hintColor,
                            fontSize: Dimensions.fontSizeSmall,
                          ),overflow: TextOverflow.ellipsis ,
                        ),
                      )
