...
class NotificationHelper {
  ...
  static void notificationRouteCheck(Map<String,dynamic> data, {bool formSplash = false}){
    if (data['action'] == "new_message_arrived") {
      Get.find<MessageController>().getConversation(data['type'], 1);
      _toRoute(formSplash, MessageScreen(channelId: data['type'], tripId: data['ride_request_id'], userName: data['user_name']));
      ...
      if(formSplash) {
        _toRoute(formSplash, const HomeScreen());
      }
      ...
      _toRoute(formSplash, const TripScreen(fromProfile: true));
